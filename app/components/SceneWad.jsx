...
// Tables
import Wadrobe1 from "app/components/3dComponents/wardrobes/Wadrobe1.jsx"
import Wadrobe2 from "app/components/3dComponents/wardrobes/Wadrobe2.jsx"
import Wadrobe3 from "app/components/3dComponents/wardrobes/Wadrobe3.jsx"
import Wadrobe4 from "app/components/3dComponents/wardrobes/Wadrobe4.jsx"
  ...
  return (
    <>
      ...
      {/* {mesh} */}
       ...
       { state.currentWad==="Wad1" &&
        <Wadrobe1 castShadow/>
       }
        { state.currentWad==="Wad2" &&
        <Wadrobe2 castShadow/>
       }
       { state.currentWad==="Wad3" &&
        <Wadrobe3 castShadow/>
       }
       { state.currentWad==="Wad4" &&
        <Wadrobe4 castShadow/>
       }
