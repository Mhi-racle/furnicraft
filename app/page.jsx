...
const Home = () => {
  return (
    ...
    <button className=' font-serif bg-black text-white mt-[50px] w-[250px] h-[40px] text-[15px]'>
      Open Configurator
      </button>
    </section>
    ...
    <p className='mt-[50px] text-[15px] font-serif'> Our stylish table models offers you the option to modify one of our available designs by givin you the option to:
    </p>
    ...
    <section className=' text-white p-10 bg-black w-full h-[250px] mt-[50px]'>
