...
import SceneBed from '@/app/components/SceneBed'
...
// Images
import Image2 from "public/images/beds/bed2.png"
import Image3 from "public/images/beds/bed3.png"
...
<section className={`${state.sideTapOpen ? " h-[780px]" : "h-10 w-6 bottom-[400px] bg-opacity-50 bg-transparent "} duration-300 w-48 md:w-80  absolute right-0 flex-row overflow-y-scroll self-center shadow-2xl bg-white rounded-md`} >
     ...
     />
      ...
      { state.currentBed==="Bed3" && <section className='flex  p-3 '>
        <Image src={Image3} height={80} width={80} alt='Bed 1' />
        <h1 className='relative top-7 text-[13px] ml-2'> Bed 1</h1>
      </section>
    }
     { state.currentBed==="Bed2" && <section className='flex  p-3 '>
        <Image src={Image2} height={80} width={80} alt='Bed 1' />
        <h1 className='relative top-7 text-[13px] ml-2'> Bed 2</h1>
      </section>
    }
      <hr/>
